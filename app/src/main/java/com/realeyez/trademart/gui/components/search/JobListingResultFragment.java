...
public class JobListingResultFragment extends Fragment {
    ...
    public JobListingResultFragment(){
    ...
    private void addJobResultPanels(MediaSearchResult result){
        JobListingSearchResultDialog panel = JobListingSearchResultDialog.inflate(getLayoutInflater(), result);
        if(panel == null){
            Logger.log("inflating that panel failed bruh!", LogLevel.WARNING);
            return;
        }
