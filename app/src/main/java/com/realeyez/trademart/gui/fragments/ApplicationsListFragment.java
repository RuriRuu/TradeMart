...
public class ApplicationsListFragment extends Fragment {
    ...
    private void loadApplications(LayoutInflater inflater){
    ...
    private ArrayList<JobItem> sendFetchRequest() throws FileNotFoundException, IOException, JSONException{
        ArrayList<JobItem> applications = new ArrayList<>();
        int employeeId = ResourceRepository.getResources().getCurrentUser().getId();
        Content content = new Content.ContentBuilder()
            .put("employee_id", employeeId)
            .build();
        Response response = RequestUtil.sendPostRequest("/jobs/applications", content);
        ...
        JSONArray applicationsJson = responseJson.getJSONObject("data").getJSONArray("applications");
